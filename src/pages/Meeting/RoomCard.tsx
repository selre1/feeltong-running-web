    ...
    <div className="RoomCard">
      ...
      <div className="RoomCard__bottom">
        <div className="RoomCard__info">
          <span className="RoomCard__memberCount" aria-label={`${room.memberCount}명 참여 중`}>
          ...
          <span className="RoomCard__dot">·</span>
          <span className="RoomCard__creator">{room.creatorNickname} · {formatDate(room.createdAt)}</span>
        </div>
